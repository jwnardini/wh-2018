...
bitly : {} 
      ...
      <div id="logo" class="clr">
        ...
        <div class="site-text-logo clr">
          ...
          <a class="itunes-subscribe" href="https://itunes.apple.com/us/podcast/what-happending/id1074483687?mt=2" target="_blank">
          <h1>APPLE SUBSCRIBE</h1>
          </a>
          <div style="width:4%;height:62px;background-color:#fff!important;float:left"></div>
          <a class="android-subscribe" href="http://subscribeonandroid.com/whathappending.libsyn.com/rss" target="_blank">
            <h1>ANDROID SUBSCRIBE</h1>
          </a>
          </div>
      ...
      <div class="subscribe-links-mobile">
          <a class="itunes-subscribe" href="https://itunes.apple.com/us/podcast/what-happending/id1074483687?mt=2" target="_blank">
          <h1>APPLE SUBSCRIBE</h1>
          </a>
          <a class="android-subscribe" href="http://subscribeonandroid.com/whathappending.libsyn.com/rss" target="_blank">
